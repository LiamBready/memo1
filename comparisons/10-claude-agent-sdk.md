...
> **Source:** [github.com/anthropics/anthropic-sdk-python](https://github.com/anthropics/anthropic-sdk-python) · [docs.anthropic.com/claude/docs/agents](https://docs.anthropic.com/claude/docs/agents)

---

## What is the Claude Agent SDK?

The Anthropic Claude Agent SDK is the official low-level library for building agents that interact with Claude models. It provides core primitives — prompting, tool use, context management — and leaves UI, persistence, scheduling, and orchestration entirely to the developer. NanoClaw is built on top of it: the SDK is the engine, NanoClaw is the car.
...
| Learning curve | Moderate — learn NanoClaw conventions, Telegram, Docker | Low if you know the SDK; high if you're building UI/persistence too |
...
- **Simpler to embed** in existing Python/Node.js projects — one install and go
...
**NanoClaw** when you want a working proactive agent with UI, memory, and credential handling in minutes and are happy with Telegram + Docker as the runtime. **Raw Claude Agent SDK** when you need maximum flexibility, lower overhead, or a custom UI/persistence layer — and are prepared to build those pieces yourself.
